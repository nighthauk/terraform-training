...
data "akamai_property_rules_builder" "tf-scriptclub_rule_default" {
  rules_v2025_09_09 {
    name      = "default"
    is_secure = true
    ...
    behavior {
      enhanced_debug {
        debug_key      = "e8cf99d63caf8b782d4170b37759f6b4c8285c663431a209424939210d4cea5f"
        disable_pragma = true
        enable_debug   = true
        generate_grn   = true
      }
...
data "akamai_property_rules_builder" "rule_traffic_reporting" {
  rules_v2025_09_09 {
    ...
    behavior {
      cp_code {
        value {
          created_date = 1755716694000
          description  = "js-scriptclub"
          id           = 1872115
          name         = "js-scriptclub"
          products     = ["Fresca", ]
        }
  ...
  rules_v2025_09_09 {
    ...
    behavior {
      redirect {
        ...
        destination_path_other = "/index.html"
